...
<script src="<%=basePath%>/js/bootstrap-table.min.js"></script>
 ...
 <div class="projects-header page-header">
	 ...
	 <button id="format" style="margin-top: 15px" type="button" class="btn btn-info glyphicon glyphicon-filter">Format</button>
    	...
    	<table id="intable" class="table table-bordered col-sm-12 col-md-12 col-lg-12" >
				<!-- <thead>
					<tr>
						...
						<th data-field="criteria">Inclusion Criteria:</th>
					</tr>
				</thead> -->
			</table>
			 <table id="extable" class="table table-bordered col-sm-12 col-md-12 col-lg-12" >
				<!-- <thead>
					<tr>
						<th data-field="id" data-width="2%">#</th>
						<th data-field="criteria">Exclusion Criteria:</th>
					</tr>
				</thead> -->
			</table>
			</div>
      ...
      <div >
      <center>
			<button id="mapping" style="margin-top: 15px; display:none " type="button" class="btn btn-success glyphicon glyphicon-search">Searching</button>
        </center> 
        </div>
        </div>
</div>
